...
public class PeblarHandler extends BaseThingHandler {
    ...
    /**
     * An exception thrown when any communication goes wrong.
     */
    private class PeblarCommunicationException extends RuntimeException {
        private PeblarCommunicationException(Exception e) {
            super(e);
        }

        private PeblarCommunicationException(String message) {
            super(message);
        }
    }
